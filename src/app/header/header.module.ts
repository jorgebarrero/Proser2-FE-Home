...
@NgModule({
  declarations: [HeaderComponent, HeaderBrandComponent, HeaderUserComponent, HeaderMenuLoginComponent, HeaderMenuSectionsComponent, HeaderConnectionComponent, HeaderTimeComponent, HeaderSectionNameComponent],
  imports: [
    CommonModule,
    // Vendor
    BsDropdownModule,
